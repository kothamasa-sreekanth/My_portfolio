        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p className="about__description mb-2">
              I'm a <b className="about__full-stack">Frontend Developer</b>{" "}
              building the Web Applications that leads to the success of the overall product.
              Check out some of my work in the Projects section.
            </p>
            <p className="mb-3 about__description">
              I'm open to Job opportunities where I can contribute, learn and
              grow. If you have a good opportunity that matches my skills and
              experience then don't hesitate to contact me.
            </p>

            <a href="#contact" className="button-contact button--flex">
              Contact
              <svg
                class="button__icon"
